...
// getting inputs information
	...
	$newKanjiRadical = htmlspecialchars($_GET['newKanjiRadical']);
...
//adding kanji
	if ($action == 'add') { 
		$mysqli->query("INSERT INTO kanji (`ID`, `kanji_view`, `key_num`, `kanji_ons_kana`, `kanji_kuns_kana`, `kanji_search`) VALUES (NULL, '$newKanjiView', '$newKanjiRadical', '$newKanjiOns', '$newKanjiKuns', '$newKanjiSearch')");
