...
function checkAnswers() {
	let answerFieldOns = document.querySelector('.answer-field__item-ons'),
			answerFieldKuns = document.querySelector('.answer-field__item-kuns'),
			answerFieldMeanings = document.querySelector('.answer-field__item-meanings');
